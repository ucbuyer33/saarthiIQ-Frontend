...
import { TrendingUp, CheckCircle2, XCircle, Lightbulb, Search, Brain, Sparkles, FileText } from 'lucide-react'
              ...
              {gapResult.matched_skills?.length > 0 && (
                <div className={styles.resultSection}>
                  <div className={styles.resultSectionHeader}>
                    ...
                    <span className={styles.resultCount}>{gapResult.matched_skills.length}</span>
                  </div>
              ...
              {gapResult.missing_skills?.length > 0 && (
                <div className={styles.resultSection}>
                  <div className={styles.resultSectionHeader}>
                    ...
                    <span className={styles.resultCount}>{gapResult.missing_skills.length}</span>
                  </div>
                  <div className={styles.chipGrid}>
