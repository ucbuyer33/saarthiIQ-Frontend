      ...
      <div className={styles.left}>
        ...
        <main className={styles.leftContent}>
          ...
          <p className={styles.leftDesc}>
            ...
            intelligent candidate matching and streamlined ATS workflows to hire the right talent faster
          </p>
          ...
          <div className={styles.stats}>
            ...
            <div className={styles.stat}>
              ...
              <span className={styles.statLabel}>Candidate Profiles</span>
            </div>
          </div>
        </main>
        ...
        <footer className={styles.avatarRow}>
          ...
          <span className={styles.avatarLabel}>Trusted by Hiring Teams Across Industries</span>
        </footer>
      </div>
      ...
      <div className={styles.right}>
        <div className={styles.card}>
          <div className={styles.cardHeader}>
            ...
            <p className={styles.subtitle}>Sign in to continue your Recruiting journey</p>
          </div>
