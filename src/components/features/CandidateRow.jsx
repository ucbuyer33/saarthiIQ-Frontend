  ...
  return (
    ...
    >
      ...
      <div className={styles.candidate}>
        ...
        {candidate.user_id && (
          <span style={{ fontSize: 'var(--text-xs)', fontFamily: 'var(--font-mono)', color: '#6366f1', background: 'rgba(99,102,241,0.1)', padding: '2px 6px', borderRadius: 4, marginRight: 'var(--space-2)' }}>
            {candidate.user_id}
          </span>
        )}
